...
keywords:
  - Skilled Migrant Category August 2026 AEWV employer
  - SMC 2026 NZ residence changes
  - AEWV employer support residence
  - accredited employer residence pathway NZ
tags:
  - aewv
  - residence
  - skilled-migrant
  - accreditation
poll:
  question: "How many of your current AEWV workers are on a trajectory toward Skilled Migrant Category residence?"
  options:
    - "Several — it's part of the employment offer"
    - "A few — but we don't actively track it"
    - "None that we're aware of"
    - "We haven't connected AEWV to residence pathways yet"
---

Further changes to New Zealand's Skilled Migrant Category take effect on 24 August 2026.[^1] For accredited employers who have positioned residence pathways as part of their AEWV retention proposition, the changes are worth reviewing before August — not because the employer applies, but because the workers in your AEWV workforce may be affected by what changes, and how you have structured their employment may determine whether the pathway remains available to them.
...
The Skilled Migrant Category is a points-based pathway. Points are accumulated across several criteria: occupational skill level, New Zealand qualifications, New Zealand work experience, and employment circumstances.[^2] An employer's role in that calculation is indirect but material — the type of role, the ANZSCO skill level, and the nature of the employment relationship all affect which criteria a worker can claim.

Employer support — where an accredited employer formally backs a worker's residence application — strengthens the application. Active AEWV employer accreditation is part of what makes that support credible. An employer who lapses their accreditation, or who is on the stand-down list, cannot provide that support in any meaningful form. The [accreditation lapse article]({{< ref "/blog/aewv-accreditation-lapse-consequences" >}}) covers what that gap costs in practice.

For employers running long-term retention propositions that include an SMC pathway, the category settings are not background context — they are a direct factor in whether the proposition is deliverable on the timeline you have implied.
...
We are trying to understand how widely accredited employers have built SMC residence pathways into their AEWV employment propositions — whether it is an active part of the offer, something discussed informally, or something workers manage independently. The [home-page survey]({{< ref "/" >}}) takes about five minutes. If the August 2026 changes are affecting your planning or your workers' plans, we would value hearing about it. No cost, no commitment.

{{< callout type="warning" >}}
**On the nature of this writing.** These are field notes on AEWV settings as we read them at the time of writing. They are not legal, immigration, or compliance advice. The Skilled Migrant Category criteria that apply to any specific application are those in force at the time of application — not this post. For decisions affecting your workers' residence applications or your accreditation, engage a licensed immigration adviser or a New Zealand-qualified lawyer.
{{< /callout >}}
